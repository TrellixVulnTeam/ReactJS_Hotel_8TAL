<?php
    ...
    class RoomStatus extends ConnectDataBase{
        ...
        public function insertRoomStatus($room_id, $arrive, $depart) {
            $result = $this->connect()->query("INSERT INTO roomstatus (room_id, arrive, depart) VALUES ('$room_id', '$arrive', '$depart')");
            return $result;
        }
    ...
    class RoomBook extends ConnectDataBase{
        public function insertRoomBook($user_id, $room_id, $phone, $arrive, $depart) {
            $result = $this->connect()->query("INSERT INTO roombooks(user_id, room_id, phone, arrive, status, depart, payment) values ('$user_id', '$room_id', '$phone', '$arrive','pending', '$depart','paid')");
            return $result;
        }
    }
    ...
    class Basket extends ConnectDataBase {
        ...
        public function getBasketByID($basket_id) {
            $result = $this->connect()->query("SELECT * FROM basket WHERE room_id = '$basket_id' ORDER BY room_id ASC");
            return $result;
        }

        public function deleteBasketByUserID($user_id) {
            $result = $this->connect()->query("DELETE FROM basket WHERE user_id = '$user_id'");
            return $result;
        }
    }
?>