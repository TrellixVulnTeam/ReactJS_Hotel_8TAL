import React, { Component } from 'react';
        import '../css/reservertion2.css';
        class Reservertion2 extends Component {
            constructor(props){
                super(props);
                this.state={
                    name:'',
                                ...
                                <div className="col-lg-9 col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div className="widget widget_check_availability widget-1">
                                        ...
                                        <div className="check_availability-field booking-information">
                                            <div className="col-lg-10"><b>Name:</b> <span>{this.state.name}</span></div>
                                            <div className="col-lg-10"><b>Email:</b> <span>{this.state.email}</span></div>
                                            <div className="col-lg-10"><b>Phone:</b> <span>{this.state.number}</span></div>
                        ...
                        <div className="modal fade" id="update_modal" aria-hidden="true">
                            ...
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    ...
                                    <div className="form-group">
                                        <label>Name</label>
                                        <input type="text" name="name" defaultValue="Nguyen Dinh Kha" className="form-control" required="required" value={this.state.name} onChange={this.myhandleChange}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Email</label>
                                        <input type="text" name="email" defaultValue="dinhkhakl01@gmail.com" className="form-control" required="required" value={this.state.email} onChange={this.myhandleChange}/>
                                    </div>
                                    <div className="form-group">
                                        <label>Phone</label>
                                        <input type="text" name="phone" className="form-control" required="required" value={this.state.phone} onChange={this.myhandleChange}/>
                                    </div>
                                    </div>
                                </div>
