...
<head>
    ...
    <!--favicon-->
   <link rel="icon" href="assets/images/logo.png" type="image/x-icon">    <!-- Bootstrap core CSS-->
    ...
    <div id="wrapper">
        ...
        <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
            ...
            <ul class="sidebar-menu do-nicescrol">
                ...
                <li>
                    <a href="forms.php">
                        <i class="fa fa-plus-square" aria-hidden="true"></i></i> <span>Forms Add</span>
                    </a>
                </li>
