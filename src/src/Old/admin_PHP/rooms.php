...
<!-- 
                <li>
                    <a href="contact.php">
                        <i class="fa fa-comment" aria-hidden="true"></i> <span>Contact</span>
                    </a>
                </li> -->
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                        ...
                        <div class="card">
                            <div class="card-body">
                            <h2>View Rooms</h2>
                                <a href="addRoom.php" class="btn btn-primary" style="float:left;">Add New Room</a>
                                ...
                                <div class="table-responsive table-hover">
                                        ...
                                        <?php 
                                                $roomObj = new Rooms();
                                                $rooms = $roomObj->displayData(); 
                                                foreach ($rooms as $room) {
                                                ?>
                                                <tr>
                                                <td><?php echo $room['room_id'] ?></td>
                                                <td><?php echo $room['roomtype_id'] ?></td>
                                                <td><?php echo $room['noroom'] ?></td>
                                                <td><img style="width :100px" src="<?php echo $room['img'] ?>" alt=""></td>
                                                <td><?php echo $room['status'] ?></td>
                                                <td><?php echo $room['phone'] ?></td>
                                                <td>
                                                    <div style=" display: flex" width="100px" hover>
                                                    <button><a href="editRoom.php?editId=<?php echo $room['room_id'] ?>" style="color:green">
                                                    <i class="fa fa-pencil" aria-hidden="true"></i></a>&nbsp
                                                    </button>
                                                    <form action="" method="post">
                                                        <button name="delete" id="delete<?php echo $room['room_id'] ?>" value="<?php echo $room['room_id'] ?>-" style="color:red" onclick="document.getElementById('delete<?php echo $room['room_id'] ?>').value+=confirm('Are you sure want to delete this record')+'-'">
